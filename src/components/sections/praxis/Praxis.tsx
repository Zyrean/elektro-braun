...
const images = [
  '/praxis/praxis-01.png',
  '/praxis/praxis-02.png',
  '/praxis/praxis-03.png',
  '/praxis/praxis-04.png',
  '/praxis/praxis-05.png',
  '/praxis/praxis-06.png',
  '/praxis/praxis-07.png',
  '/praxis/praxis-08.png',
]
    ...
    <>
      <AppSection>
        <AppContainer>
          <SectionHeader
            title="Unsere Praxis"
            subtitle="Gerne zeigen wir euch unsere Räumlichkeiten und wie wir arbeiten."
          />
